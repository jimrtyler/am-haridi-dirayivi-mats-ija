...
#GUI Variables
$FormTitleText = "ዲስክ ማጽጃ በጂም ታይለር (PowerShellEngineer.com)"
$SelectDiskLabelText = "ዲስክ ምረጥ"
$FreeSpaceLabelText = "ነጻ ቦታ (ጊጋባይት):"
$TotalSpaceLabelText = "ጠቅላላ ቦታ (ጊጋባይት):"
$JunkFoundLabelText = "ቆሻሻ ተገኝቷል (ጊጋባይት)"
$CleanDiskBtnText = "ዲስክን አጽዳ *ፋይሎችን ይሰርዛል*"
$SpaceCleanedLabelText = "ቦታ የጸዳ (ጊጋባይት):"
$LogFileLabelText = "የመዝገብ መዝገብ የሚገኝበት: $abcdefg"
$CreditLabelText = "ስክሪፕት በጂም ታይለር - PowerShellEngineer.com"
$LogFileLocatedText = "የምዝግብ ማስታወሻ ፋይል ይገኛል"
$AnalyzingDriveText = "አሽከርካሪዎችን በመተንተን ላይ..."
$BrowsersAreRunningText = "አሳሾች እየሄዱ ነው... ተጠቃሚን በማሳወቅ ላይ..."
$PleaseCloseBrowsersText = "እባክዎ ሁሉንም የድር አሳሾች ይዝጉ እና እንደገና ይሞክሩ።"
$CleaningDriveText = "አሽከርካሪን በማጽዳት ላይ..."
